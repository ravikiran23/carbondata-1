...
public class CarbonCompactionUtil {
     ...
     * @return
     */
    public static Map<Integer, Map<String, List<TableBlockInfo>>> createMappingForSegments
    (List<TableBlockInfo> tableBlockInfoList) {

        Map<Integer, Map<String, List<TableBlockInfo>>> segmentBlockInfoMapping = new HashMap<>
                (CarbonCommonConstants.DEFAULT_COLLECTION_SIZE);

        for (TableBlockInfo info : tableBlockInfoList) {
            List<TableBlockInfo> eachSegmentBlocks = new ArrayList<>();
            int segId = info.getSegmentId();
    ...
    private static void groupCorrespodingInfoBasedOnTask(TableBlockInfo info, Map<String, List<TableBlockInfo>> taskMapping, String taskNo) {
     ...
     * @return
     */
    public static Map<Integer, List<DataFileFooter>> createDataFileMappingForSegments(List<TableBlockInfo> tableBlockInfoList) throws IndexBuilderException {

        Map<Integer, List<DataFileFooter>> segmentBlockInfoMapping = new HashMap<>();
        for (TableBlockInfo blockInfo : tableBlockInfoList) {
            List<DataFileFooter> eachSegmentBlocks = new ArrayList<>();
            int segId = blockInfo.getSegmentId();
            ...
            try {
                dataFileMatadata =
                        CarbonUtil.readMetadatFile(blockInfo.getFilePath(), blockInfo.getBlockOffset(), blockInfo.getBlockLength());
